...
#pragma warning restore BepInEx002
{
    ...
    public override void Load()
    {
        ...
        AprilFoolsMode = Config.Bind("Other", "AprilFoolsMode", "None", new ConfigDescription("Enable April Fools Mode (only client-side)", new AcceptableValueList<string>("None", "Horse", "Seeker", "Long", "LongHorse", "Classic")));
